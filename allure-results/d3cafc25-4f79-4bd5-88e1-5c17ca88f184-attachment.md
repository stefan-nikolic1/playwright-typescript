...
Call log:
  ...
  - waiting for locator('nb-card').filter({ hasText: 'Using the Grid' })
    - locator resolved to <nb-card _nghost-jmo-c98="" _ngcontent-jmo-c290="">…</nb-card>
...
```yaml
- generic [ref=f238e7]:
  - navigation [ref=f238e9]:
    - generic [ref=f238e10]:
      - generic [ref=f238e11]:
        - generic [ref=f238e12]:
          - link [ref=f238e13] [cursor=pointer]:
            - /url: "#"
          - link "PW-test" [ref=f238e23] [cursor=pointer]:
            - /url: "#"
        - button "Light" [ref=f238e25] [cursor=pointer]
      - generic [ref=f238e34]:
        - button [ref=f238e37] [cursor=pointer]
        - link [ref=f238e45] [cursor=pointer]:
          - /url: "#"
        - link [ref=f238e53] [cursor=pointer]:
          - /url: "#"
        - generic [ref=f238e60]: Nick Jones
  - generic [ref=f238e66]:
    - list [ref=f238e71]:
      - listitem [ref=f238e72]:
        - link "IoT Dashboard" [ref=f238e73] [cursor=pointer]:
          - /url: /pages/iot-dashboard
      - listitem [ref=f238e80]:
        - generic [ref=f238e81]: FEATURES
      - listitem [ref=f238e82]:
        - link "Forms" [expanded] [ref=f238e83] [cursor=pointer]:
          - /url: "#"
        - list [ref=f238e97]:
          - listitem [ref=f238e98]:
            - link "Form Layouts" [ref=f238e99] [cursor=pointer]:
              - /url: /pages/forms/layouts
          - listitem [ref=f238e100]:
            - link "Datepicker" [ref=f238e101] [cursor=pointer]:
              - /url: /pages/forms/datepicker
      - listitem [ref=f238e102]:
        - link "Modal & Overlays" [ref=f238e103] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f238e118]:
            - link "Dialog" [ref=f238e119] [cursor=pointer]:
              - /url: /pages/modal-overlays/dialog
          - listitem [ref=f238e120]:
            - link "Window" [ref=f238e121] [cursor=pointer]:
              - /url: /pages/modal-overlays/window
          - listitem [ref=f238e122]:
            - link "Popover" [ref=f238e123] [cursor=pointer]:
              - /url: /pages/modal-overlays/popover
          - listitem [ref=f238e124]:
            - link "Toastr" [ref=f238e125] [cursor=pointer]:
              - /url: /pages/modal-overlays/toastr
          - listitem [ref=f238e126]:
            - link "Tooltip" [ref=f238e127] [cursor=pointer]:
              - /url: /pages/modal-overlays/tooltip
      - listitem [ref=f238e128]:
        - link "Extra Components" [ref=f238e129] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f238e145]:
            - link "Calendar" [ref=f238e146] [cursor=pointer]:
              - /url: /pages/extra-components/calendar
      - listitem [ref=f238e147]:
        - link "Charts" [ref=f238e148] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f238e162]:
            - link "Echarts" [ref=f238e163] [cursor=pointer]:
              - /url: /pages/charts/echarts
      - listitem [ref=f238e164]:
        - link "Tables & Data" [ref=f238e165] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f238e181]:
            - link "Smart Table" [ref=f238e182] [cursor=pointer]:
              - /url: /pages/tables/smart-table
          - listitem [ref=f238e183]:
            - link "Tree Grid" [ref=f238e184] [cursor=pointer]:
              - /url: /pages/tables/tree-grid
      - listitem [ref=f238e185]:
        - link "Auth" [ref=f238e186] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f238e200]:
            - link "Login" [ref=f238e201] [cursor=pointer]:
              - /url: /auth/login
          - listitem [ref=f238e202]:
            - link "Register" [ref=f238e203] [cursor=pointer]:
              - /url: /auth/register
          - listitem [ref=f238e204]:
            - link "Request Password" [ref=f238e205] [cursor=pointer]:
              - /url: /auth/request-password
          - listitem [ref=f238e206]:
            - link "Reset Password" [ref=f238e207] [cursor=pointer]:
              - /url: /auth/reset-password
    - generic [ref=f238e208]:
      - generic [ref=f238e212]:
        - generic [ref=f238e215]:
          - generic [ref=f238e216]: Inline form
          - generic [ref=f238e218]:
            - textbox "Jane Doe" [ref=f238e219]
            - textbox "Email" [ref=f238e220]
            - generic [ref=f238e222]:
              - checkbox "Remember me" [ref=f238e223]
              - generic [ref=f238e225]: Remember me
            - button "Submit" [ref=f238e226] [cursor=pointer]
        - generic [ref=f238e227]:
          - generic [ref=f238e228]:
            - generic [ref=f238e229]:
              - generic [ref=f238e230]: Using the Grid
              - generic [ref=f238e232]:
                - generic [ref=f238e233]:
                  - generic [ref=f238e234]: Email
                  - textbox "Email" [ref=f238e236]
                - generic [ref=f238e237]:
                  - generic [ref=f238e238]: Password
                  - textbox "Password" [ref=f238e240]
                - generic [ref=f238e241]:
                  - generic [ref=f238e242]: Radios
                  - generic [ref=f238e244]:
                    - generic [ref=f238e246]:
                      - radio "Option 1" [ref=f238e247]
                      - generic [ref=f238e250]: Option 1
                    - generic [ref=f238e252]:
                      - radio "Option 2" [checked] [active] [ref=f238e253]
                      - generic [ref=f238e256]: Option 2
                    - generic [ref=f238e258]:
                      - radio "Disabled Option" [disabled] [ref=f238e259]
                      - generic [ref=f238e262]: Disabled Option
                - button "Sign in" [ref=f238e265] [cursor=pointer]
            - generic [ref=f238e266]:
              - generic [ref=f238e267]: Form without labels
              - generic [ref=f238e269]:
                - textbox "Recipients" [ref=f238e271]
                - textbox "Subject" [ref=f238e273]
                - textbox "Message" [ref=f238e275]
                - button "Send" [ref=f238e276] [cursor=pointer]
          - generic [ref=f238e277]:
            - generic [ref=f238e278]:
              - generic [ref=f238e279]: Basic form
              - generic [ref=f238e281]:
                - generic [ref=f238e282]:
                  - generic [ref=f238e283]: Email address
                  - textbox "Email address" [ref=f238e284]:
                    - /placeholder: Email
                - generic [ref=f238e285]:
                  - generic [ref=f238e286]: Password
                  - textbox "Password" [ref=f238e287]
                - generic [ref=f238e290]:
                  - checkbox "Check me out" [ref=f238e291]
                  - generic [ref=f238e293]: Check me out
                - button "Submit" [ref=f238e294] [cursor=pointer]
            - generic [ref=f238e295]:
              - generic [ref=f238e296]: Block form
              - generic [ref=f238e297]:
                - generic [ref=f238e298]:
                  - generic [ref=f238e300]:
                    - generic [ref=f238e301]: First Name
                    - textbox "First Name" [ref=f238e302]
                  - generic [ref=f238e304]:
                    - generic [ref=f238e305]: Last Name
                    - textbox "Last Name" [ref=f238e306]
                - generic [ref=f238e307]:
                  - generic [ref=f238e309]:
                    - generic [ref=f238e310]: Email
                    - textbox "Email" [ref=f238e311]
                  - generic [ref=f238e313]:
                    - generic [ref=f238e314]: Website
                    - textbox "Website" [ref=f238e315]
                - button "Submit" [ref=f238e316] [cursor=pointer]
        - generic [ref=f238e319]:
          - generic [ref=f238e320]: Horizontal form
          - generic [ref=f238e322]:
            - generic [ref=f238e323]:
              - generic [ref=f238e324]: Email
              - textbox "Email" [ref=f238e326]
            - generic [ref=f238e327]:
              - generic [ref=f238e328]: Password
              - textbox "Password" [ref=f238e330]
            - generic [ref=f238e335]:
              - checkbox "Remember me" [ref=f238e336]
              - generic [ref=f238e338]: Remember me
            - button "Sign in" [ref=f238e341] [cursor=pointer]
      - navigation [ref=f238e343]:
        - generic [ref=f238e344]:
          - generic [ref=f238e345]:
            - text: Created with ♥ by
            - link "Akveo" [ref=f238e347] [cursor=pointer]:
              - /url: https://akveo.page.link/8V2f
            - text: "2019"
          - generic [ref=f238e348]:
            - link "" [ref=f238e349] [cursor=pointer]:
              - /url: "#"
            - link "" [ref=f238e350] [cursor=pointer]:
              - /url: "#"
            - link "" [ref=f238e351] [cursor=pointer]:
              - /url: "#"
            - link "" [ref=f238e352] [cursor=pointer]:
              - /url: "#"
```
