...
Call log:
  ...
  - waiting for locator('nb-card').filter({ hasText: 'Using the Grid' })
    - locator resolved to <nb-card _nghost-obv-c98="" _ngcontent-obv-c290="">…</nb-card>
...
```yaml
- generic [ref=f242e7]:
  - navigation [ref=f242e9]:
    - generic [ref=f242e10]:
      - generic [ref=f242e11]:
        - generic [ref=f242e12]:
          - link [ref=f242e13] [cursor=pointer]:
            - /url: "#"
          - link "PW-test" [ref=f242e23] [cursor=pointer]:
            - /url: "#"
        - button "Light" [ref=f242e25] [cursor=pointer]
      - generic [ref=f242e34]:
        - button [ref=f242e37] [cursor=pointer]
        - link [ref=f242e45] [cursor=pointer]:
          - /url: "#"
        - link [ref=f242e53] [cursor=pointer]:
          - /url: "#"
        - generic [ref=f242e60]: Nick Jones
  - generic [ref=f242e66]:
    - list [ref=f242e71]:
      - listitem [ref=f242e72]:
        - link "IoT Dashboard" [ref=f242e73] [cursor=pointer]:
          - /url: /pages/iot-dashboard
      - listitem [ref=f242e80]:
        - generic [ref=f242e81]: FEATURES
      - listitem [ref=f242e82]:
        - link "Forms" [expanded] [ref=f242e83] [cursor=pointer]:
          - /url: "#"
        - list [ref=f242e97]:
          - listitem [ref=f242e98]:
            - link "Form Layouts" [ref=f242e99] [cursor=pointer]:
              - /url: /pages/forms/layouts
          - listitem [ref=f242e100]:
            - link "Datepicker" [ref=f242e101] [cursor=pointer]:
              - /url: /pages/forms/datepicker
      - listitem [ref=f242e102]:
        - link "Modal & Overlays" [ref=f242e103] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f242e118]:
            - link "Dialog" [ref=f242e119] [cursor=pointer]:
              - /url: /pages/modal-overlays/dialog
          - listitem [ref=f242e120]:
            - link "Window" [ref=f242e121] [cursor=pointer]:
              - /url: /pages/modal-overlays/window
          - listitem [ref=f242e122]:
            - link "Popover" [ref=f242e123] [cursor=pointer]:
              - /url: /pages/modal-overlays/popover
          - listitem [ref=f242e124]:
            - link "Toastr" [ref=f242e125] [cursor=pointer]:
              - /url: /pages/modal-overlays/toastr
          - listitem [ref=f242e126]:
            - link "Tooltip" [ref=f242e127] [cursor=pointer]:
              - /url: /pages/modal-overlays/tooltip
      - listitem [ref=f242e128]:
        - link "Extra Components" [ref=f242e129] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f242e145]:
            - link "Calendar" [ref=f242e146] [cursor=pointer]:
              - /url: /pages/extra-components/calendar
      - listitem [ref=f242e147]:
        - link "Charts" [ref=f242e148] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f242e162]:
            - link "Echarts" [ref=f242e163] [cursor=pointer]:
              - /url: /pages/charts/echarts
      - listitem [ref=f242e164]:
        - link "Tables & Data" [ref=f242e165] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f242e181]:
            - link "Smart Table" [ref=f242e182] [cursor=pointer]:
              - /url: /pages/tables/smart-table
          - listitem [ref=f242e183]:
            - link "Tree Grid" [ref=f242e184] [cursor=pointer]:
              - /url: /pages/tables/tree-grid
      - listitem [ref=f242e185]:
        - link "Auth" [ref=f242e186] [cursor=pointer]:
          - /url: "#"
        - list:
          - listitem [ref=f242e200]:
            - link "Login" [ref=f242e201] [cursor=pointer]:
              - /url: /auth/login
          - listitem [ref=f242e202]:
            - link "Register" [ref=f242e203] [cursor=pointer]:
              - /url: /auth/register
          - listitem [ref=f242e204]:
            - link "Request Password" [ref=f242e205] [cursor=pointer]:
              - /url: /auth/request-password
          - listitem [ref=f242e206]:
            - link "Reset Password" [ref=f242e207] [cursor=pointer]:
              - /url: /auth/reset-password
    - generic [ref=f242e208]:
      - generic [ref=f242e212]:
        - generic [ref=f242e215]:
          - generic [ref=f242e216]: Inline form
          - generic [ref=f242e218]:
            - textbox "Jane Doe" [ref=f242e219]
            - textbox "Email" [ref=f242e220]
            - generic [ref=f242e222]:
              - checkbox "Remember me" [ref=f242e223]
              - generic [ref=f242e225]: Remember me
            - button "Submit" [ref=f242e226] [cursor=pointer]
        - generic [ref=f242e227]:
          - generic [ref=f242e228]:
            - generic [ref=f242e229]:
              - generic [ref=f242e230]: Using the Grid
              - generic [ref=f242e232]:
                - generic [ref=f242e233]:
                  - generic [ref=f242e234]: Email
                  - textbox "Email" [ref=f242e236]
                - generic [ref=f242e237]:
                  - generic [ref=f242e238]: Password
                  - textbox "Password" [ref=f242e240]
                - generic [ref=f242e241]:
                  - generic [ref=f242e242]: Radios
                  - generic [ref=f242e244]:
                    - generic [ref=f242e246]:
                      - radio "Option 1" [ref=f242e247]
                      - generic [ref=f242e250]: Option 1
                    - generic [ref=f242e252]:
                      - radio "Option 2" [checked] [active] [ref=f242e253]
                      - generic [ref=f242e256]: Option 2
                    - generic [ref=f242e258]:
                      - radio "Disabled Option" [disabled] [ref=f242e259]
                      - generic [ref=f242e262]: Disabled Option
                - button "Sign in" [ref=f242e265] [cursor=pointer]
            - generic [ref=f242e266]:
              - generic [ref=f242e267]: Form without labels
              - generic [ref=f242e269]:
                - textbox "Recipients" [ref=f242e271]
                - textbox "Subject" [ref=f242e273]
                - textbox "Message" [ref=f242e275]
                - button "Send" [ref=f242e276] [cursor=pointer]
          - generic [ref=f242e277]:
            - generic [ref=f242e278]:
              - generic [ref=f242e279]: Basic form
              - generic [ref=f242e281]:
                - generic [ref=f242e282]:
                  - generic [ref=f242e283]: Email address
                  - textbox "Email address" [ref=f242e284]:
                    - /placeholder: Email
                - generic [ref=f242e285]:
                  - generic [ref=f242e286]: Password
                  - textbox "Password" [ref=f242e287]
                - generic [ref=f242e290]:
                  - checkbox "Check me out" [ref=f242e291]
                  - generic [ref=f242e293]: Check me out
                - button "Submit" [ref=f242e294] [cursor=pointer]
            - generic [ref=f242e295]:
              - generic [ref=f242e296]: Block form
              - generic [ref=f242e297]:
                - generic [ref=f242e298]:
                  - generic [ref=f242e300]:
                    - generic [ref=f242e301]: First Name
                    - textbox "First Name" [ref=f242e302]
                  - generic [ref=f242e304]:
                    - generic [ref=f242e305]: Last Name
                    - textbox "Last Name" [ref=f242e306]
                - generic [ref=f242e307]:
                  - generic [ref=f242e309]:
                    - generic [ref=f242e310]: Email
                    - textbox "Email" [ref=f242e311]
                  - generic [ref=f242e313]:
                    - generic [ref=f242e314]: Website
                    - textbox "Website" [ref=f242e315]
                - button "Submit" [ref=f242e316] [cursor=pointer]
        - generic [ref=f242e319]:
          - generic [ref=f242e320]: Horizontal form
          - generic [ref=f242e322]:
            - generic [ref=f242e323]:
              - generic [ref=f242e324]: Email
              - textbox "Email" [ref=f242e326]
            - generic [ref=f242e327]:
              - generic [ref=f242e328]: Password
              - textbox "Password" [ref=f242e330]
            - generic [ref=f242e335]:
              - checkbox "Remember me" [ref=f242e336]
              - generic [ref=f242e338]: Remember me
            - button "Sign in" [ref=f242e341] [cursor=pointer]
      - navigation [ref=f242e343]:
        - generic [ref=f242e344]:
          - generic [ref=f242e345]:
            - text: Created with ♥ by
            - link "Akveo" [ref=f242e347] [cursor=pointer]:
              - /url: https://akveo.page.link/8V2f
            - text: "2019"
          - generic [ref=f242e348]:
            - link "" [ref=f242e349] [cursor=pointer]:
              - /url: "#"
            - link "" [ref=f242e350] [cursor=pointer]:
              - /url: "#"
            - link "" [ref=f242e351] [cursor=pointer]:
              - /url: "#"
            - link "" [ref=f242e352] [cursor=pointer]:
              - /url: "#"
```
