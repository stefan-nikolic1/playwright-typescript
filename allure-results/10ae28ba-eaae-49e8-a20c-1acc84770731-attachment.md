...
```
Error: A snapshot doesn't exist at /Users/stefannikolic/Documents/demo/pw-practice-app/tests/uiComponents.spec.ts-snapshots/Form-Layouts-page-radio-buttons-1-firefox-darwin.png, writing actual.
```
